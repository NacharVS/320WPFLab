...
namespace Core
{
    public abstract class characteristics
    {
        ...
        private MagChar _magic => new MagChar(Strength, Dexterity, Intelligence, Constitution);
        public MagChar Magic
        {
            get { return _magic; }
        }
        private PhyChar _physic => new PhyChar(Strength, Dexterity, Intelligence, Constitution);
        public PhyChar Physic
        {
            get { return _physic; }
        }
